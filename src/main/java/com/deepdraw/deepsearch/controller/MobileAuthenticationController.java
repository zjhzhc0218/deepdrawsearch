...
public class MobileAuthenticationController {
    ...
    // 替换成你的AK
    final String accessKeyId = "LTAIjKquZdOADXca";// 你的accessKeyId
    final String accessKeySecret = "alGA4Y9kUDLHJg6gPm0mFk4e9pTRhm";// 你的accessKeySecret
    ...
    // 必填:短信签名-可在短信控制台中找到
        request.setSignName("白马查");
    // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_152287053");
