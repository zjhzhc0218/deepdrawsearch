        ...
        <div class="nav-list container">
            <div class="row" style="text-align: center">
                <#--<div class="col-md-12">-->
                    ...
                    <div class="one ">
                        <img class="header_hotIcon" src="/codeimg/hot.gif">
                ...
                <ul class="dsr-info" id="dsr" style="">
                    ...
                    <li class="J_RateInfoTrigger dsr-item selected">
                        <div class="item-scrib">
                            ...
                            <em title="计算规则:(店铺得分-同行业平均分)/(同行业店铺最高得分-同行业平均分)"><strong class="percent over" id="">比同行业平均水平{{dtPingFeng.examedContext[15].value}} <b style="color:#f60"  ng-bind="dtPingFeng.examedContext[6].value"></b></strong></em>
                        </div>
                    ...
                    <li class="J_RateInfoTrigger dsr-item selected">
                        <div class="item-scrib">
                            ...
                            <em title="计算规则:(店铺得分-同行业平均分)/(同行业店铺最高得分-同行业平均分)"><strong class="percent over" id="">比同行业平均水平{{dtPingFeng.examedContext[15].value}} <b style="color:#f60"  ng-bind="dtPingFeng.examedContext[11].value"></b></strong></em>
                        </div>
            ...
            <div class="result-context" ng-show="shangxiajia.examedContext != null&&shangxiajia.examedContext.length>0" >
                <table class="table table-hover up_table " style="  display: block;width:100%;margin-bottom: 0px;">
                    ...
                    <tr style="width:100%" >
                        ...
                        <td ><b   ng-bind="shangxiajia.examedContext[1].value"></b></td>
                        <td><b   ng-bind="shangxiajia.examedContext[2].value"></b></td>
                        <td><b  ng-bind="shangxiajia.examedContext[3].value"></b></td>
                        <td ><b  ng-bind="shangxiajia.examedContext[4].value"></b>天<b ng-bind="shangxiajia.examedContext[5].value"></b>小时</td>
                    </tr>
                    </tbody>
                </table>
            </div>
...
<script>
    ...
    (function() {
        ...
        hm.src = "https://hm.baidu.com/hm.js?5a65aca4dd610b66617832e3b5668a8f";
